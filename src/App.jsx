...
function LoginPage({ onLogin }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: '#111', border: '1px solid #1f2937', borderRadius: 12, padding: 40, width: 340 }}>
...
export default function Portfolio() {
  ...
  if (showLogin) return <LoginPage onLogin={() => { setIsAdmin(true); setShowLogin(false) }} />
